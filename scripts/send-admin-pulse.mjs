...
const subject = "Deskfit weekly affiliate pulse";
const text = ["Deskfit weekly pulse", "", "Guides live: 5", "Curated ASINs: 6", "Amazon tag: abbeybench-20", "", "Run npm run report:weekly for the local markdown report."].join("\n");
